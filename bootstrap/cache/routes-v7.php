...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    2 => 
    array (
      0 => '{^(?|/s(?|ell/([^/]++)(*:24)|torage/(.*)(*:42))|/reset\\-password/([^/]++)(*:75)|/verify\\-email/([^/]++)/([^/]++)(*:114))/?$}sDu',
    ),
    3 => 
    array (
      24 => 
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\DashboardController@sell',
        'controller' => 'App\\Http\\Controllers\\DashboardController@sell',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
